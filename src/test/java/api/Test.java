...
//		List<ImovinskaKarta> list = session.createCriteria(ImovinskaKarta.class).list();
//		List<MedjunarodnaOrganizacija> list = session.createCriteria(MedjunarodnaOrganizacija.class).list();
//		List<WebPrezentacija> list = session.createCriteria(WebPrezentacija.class).list();
